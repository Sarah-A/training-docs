    ...
    public static class ConcatUnion
    {
            ...
            IEnumerable<News> newsCollection)
        {
            return newsCollection
                ...
                .Take(3)
                .Union(newsCollection.Where(news => news.Priority == Priority.High));
        }
        ...
        {
            var lettresOnly = word
                .Where(letter => char.IsLetter(letter));

            var symbolsOnly = word
                .Where(letter => !char.IsLetter(letter))
                .Distinct();

            return String.Join("", lettresOnly.Concat(symbolsOnly));
        ...
        {
            return numbers1
                 .Where(IsPerfectSquare)
                 .Union(numbers2.Where(IsPerfectSquare))
                 .OrderBy(num => num);
        }
