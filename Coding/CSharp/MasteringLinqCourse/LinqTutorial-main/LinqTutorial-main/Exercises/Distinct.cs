...
namespace Exercises
{
    public static class Distinct
    {
        ...
        private static int NumberOfDuplicates<T>(IEnumerable<T> collection)
        {
        ...
        {
            return collections
                .OrderByDescending(collection => NumberOfDuplicates(collection))
                .ThenBy(collection => collection.Count())
                .FirstOrDefault();
        }
