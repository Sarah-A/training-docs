...
namespace Exercises
{
    public static class PrependAppend
    {
        ...
        public static IEnumerable<string> AddStartAndEndMarkers(IEnumerable<string> words)
        {
            ...
            {
                result = result.Prepend(new string(Start));
            }
            if (words.Last() != End)
            {
                result = result.Append(new string(End));
            }
            return result;
        }
        ...
        */
            ...
            IEnumerable<int> numbers)
        {
            ...
            return numbers
                .Where(num => num != firstNum)
                .Prepend(firstNum)
                .Where(num => num != lastNum)
                .Append(lastNum);            
        }
        ...
        {
            const string oldEnding = "The end";
            const string newEnding = "END";
            return words
                .TakeWhile(word => word != oldEnding)
                .Append(newEnding);
        }
